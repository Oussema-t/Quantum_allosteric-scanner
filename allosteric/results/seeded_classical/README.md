...
| **heat kernel e^{-Lt} — the exact classical twin** | **0.512** | 407/630 | **2.3e-12** |
...
**Distal split vs the twin:** distal (n=91) CTQW 0.617 vs heat kernel **0.275**; near (n=539) 0.597 vs 0.553.
Classical diffusion from the active site is *below chance* on distal targets. The quantum walk is not.

## Why this is the test that matters

The heat kernel e^{-Lt} is the CTQW's exact classical twin: same Laplacian, same seed, same
time-averaging grid, probabilities instead of amplitudes. Nothing else differs. The rubric's test
...
significantly outperforms its exact classical diffusion twin and six other seeded classical
measures under identical conditions (p = 2.3e-12 against the twin), with the largest margin on
