...
- Existing domain-specific guidance under `modules/testkube-agent-jet-ve/testkube-test-data/playwright/.claude/` remains authoritative until migration is planned explicitly.
