...
- The current slice is recording the scaffold ripeness checkpoint and today-close rationale.
...
- Existing domain documentation in `modules/testkube-agent-jet-ve/testkube-test-data/playwright/.claude/` remains authoritative until migration work is scoped explicitly.
