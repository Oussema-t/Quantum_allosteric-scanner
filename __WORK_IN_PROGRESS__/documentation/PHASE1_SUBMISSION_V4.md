...
The apo-vs-stripped-holo delta that was the third component of this instrument is no longer part of the proposal: we ran it, and it is reported above. What remains to build is (a) the certifying benchmark and (c) the hard-regime screening criterion.
