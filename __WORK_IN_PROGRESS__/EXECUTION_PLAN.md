...
gate) has no dependency and should run in parallel immediately** — per the panel, "the
highest information-per-hour experiment available," one afternoon, no quantum required.
