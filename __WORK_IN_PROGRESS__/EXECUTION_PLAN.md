...
|---|---|---|---|
| 22 (TASK-0070, TASK-0052, TASK-0047, TASK-0058, TASK-0063, TASK-0055, TASK-0064, TASK-0071, TASK-0056, TASK-0067, TASK-0079, TASK-0074, TASK-0066, TASK-0094, TASK-0095, TASK-0097, TASK-0096, TASK-0100, TASK-0091, TASK-0101, TASK-0103, TASK-0104) | 0 | 28 (+2: TASK-0105, TASK-0106; also not yet reflected here: TASK-0046/0075/0080/0081/0082/0092/0093 confirmed Done on disk via `.ai/COMMON.md` but not previously added to this count — a fuller reconciliation of this tracker against the registry is due, not attempted in this edit) | 50 |
...
| 5.2 | **[FILED] TASK-0082 — competence map synthesis** | The per-target floor / ceiling / headroom table — **the strategic differentiator**. "We close X% of the gap knowing the answer would close, on these targets; ~0 on those, and here is why." A per-target honest NO is a publishable result, not a failure to hide. | TODO **(gated pending Phase 1B — floor/ceiling/headroom numbers are meaningless until proximity-cleared)**. **Follow-up 2026-07-15:** no number this task synthesizes has a confidence interval (TASK-0112) or a settled ceiling column (TASK-0116/0117) — state both caveats explicitly per-row rather than reporting bare numbers if either is still open. |
...
| 5.6 | **[EXISTS] TASK-0046** — ceiling coordinate-descent search | Completes the floor/ceiling/headroom triple. | TODO **(gated pending Phase 1B, feeds 5.2)**. **Follow-up 2026-07-15:** its real KRAS_G12C ceiling (~0.525, below that target's proximity floor) has two open caveats — search coverage (TASK-0116) and CTQW parameter validity (TASK-0117) — before 5.2 should read it as settled. |
...
| 5.8 | **[FILED] TASK-0081 — generalization set (ASD targets)** | The brief **highly encourages** extra targets to demonstrate robustness/scalability. Pull 2–4 from the Allosteric Database with known sites. Cheap once 5.1 is a one-command run; directly feeds "Technical Approach / Innovation". | TODO **(gated pending Phase 1B — no point generalizing a proximity detector)**. **Follow-up 2026-07-15:** this task is now more than "encouraged extra evidence" — see TASK-0115: no `RESULTS.md` claim should be read as submission-final until checked against targets this project's ~15 review cycles haven't already seen. |
