---
description: "Run a findings-first code-quality review focused on when a local implementation should become a shared abstraction."
name: "Generalize Review"
...
- Fix the focus to `generalization`.
- Review the current slice for local implementations that should become shared abstractions, while calling out cases where premature abstraction would be harmful.
