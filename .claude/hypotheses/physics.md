...
- **Inherits HYP-P10.** If pockets aren't graph-open/void-like, this fails with
  the rest of the family. **Measured, not hypothetical: HYP-P10's 2026-07-22
  status update (TASK-0143) found 0/7 targets pass.**
...
life. b1(ker L1) == E−N+C as the setup-validity gate. **Per HYP-P10's own
now-measured result, this gate is not currently open — [[TASK-0142]] should
treat the premise as unsupported, not proceed as if it were still untested.**
