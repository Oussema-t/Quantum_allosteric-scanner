...
- introduce local automation before remote integration where repetition becomes painful

Use [LOCAL_AUTOMATION_MANUAL_ENVIRONMENTS](./LOCAL_AUTOMATION_MANUAL_ENVIRONMENTS.md) for the safe intermediate step between fully manual work and backend-integrated automation.
