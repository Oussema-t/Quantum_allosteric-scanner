...
| TASK-0003 | Reconcile and author `__WORK_IN_PROGRESS__/config/targets.yaml` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0003-targets-yaml-reconciliation.md` |
| TASK-0004 | Implement `__WORK_IN_PROGRESS__/src/allostery/labels.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0004-labels-py.md` |
| TASK-0005 | Implement `__WORK_IN_PROGRESS__/src/allostery/superpose.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0005-superpose-py.md` |
| TASK-0006 | Implement `__WORK_IN_PROGRESS__/src/allostery/protocol.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0006-protocol-py.md` |
| TASK-0007 | Implement `__WORK_IN_PROGRESS__/src/allostery/select.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0007-select-py.md` |
| TASK-0008 | Implement `__WORK_IN_PROGRESS__/src/allostery/analysis.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0008-analysis-py.md` |
| TASK-0009 | Implement `__WORK_IN_PROGRESS__/src/allostery/diagnostics.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0009-diagnostics-py.md` |
| TASK-0010 | Implement `__WORK_IN_PROGRESS__/src/allostery/report.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0010-report-py.md` |
| TASK-0011 | Implement `__WORK_IN_PROGRESS__/src/allostery/baselines.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0011-baselines-py.md` |
| TASK-0012 | Implement `__WORK_IN_PROGRESS__/src/allostery/pathways.py` | Implementer | TODO | P1 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0012-pathways-py.md` |
| TASK-0013 | Implement `__WORK_IN_PROGRESS__/src/allostery/coarse.py` | Implementer | TODO | P2 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0013-coarse-py.md` |
| TASK-0014 | Implement `__WORK_IN_PROGRESS__/src/allostery/viz.py` | Implementer | TODO | P3 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0014-viz-py.md` |
| TASK-0015 | Build the holo-direction module (`HOLO_DIRECTION_MODULE.md`) | Implementer | TODO | P2 (blocked on 0005/0006/0011) | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0015-holo-direction-module.md` |
| TASK-0016 | Add test for `heat()` behavior on indefinite `H_new` output (orphaned gap, see IMP-H4) | Implementer | TODO | P2 | 2026-07-04 | Implementer (this thread) | 2026-07-04 19:43 | `.ai/tasks/TODO/TASK-0016-heat-indefinite-hnew-test.md` |
...
| TASK-0030 | Extract a shared, unit-tested Kabsch helper in `backend/` — dedupes `discovery.py::_kabsch` / `analysis.py::_kabsch_rotate`; reuse target for TASK-0005; concrete instance of TASK-0018 evidence #6. **Scaffold-branch note:** task documentation is Done; the actual `backend/` code lands separately as its own product-code chunk, not on this branch. | Implementer | Done | P2 | 2026-07-05 | — | — | `.ai/tasks/DONE/TASK-0030-backend-kabsch-dedup.md` |
