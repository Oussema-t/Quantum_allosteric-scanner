...
| TASK-0047 | Bridge gaps from Reviewer A's Foundation Review (TASK-0003/0004/0005): add the missing network-gated KRAS_G12C integration test `labels.py`'s own TASK-0004 Intent Contract promised, and strengthen the numbering-offset test with a real alignment indel case | Implementer | TODO | P2 | 2026-07-07 | Reviewer A (this thread) | 2026-07-07 06:55 | `.ai/tasks/TODO/TASK-0047-foundation-review-gap-bridging.md` |
