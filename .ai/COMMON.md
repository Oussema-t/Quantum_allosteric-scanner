...
| TASK-0061 | Extend `claim.py stage` with an opt-in `--reflect-into <TASK-ID>` audit-trail record of exactly what was staged, when — closes the gap Q-0001's incident surfaced between a task file's prose and what actually got staged/committed | Toolsmith | TODO | P2 | 2026-07-11 | — | — | `.ai/tasks/TODO/TASK-0061-staged-files-task-audit-trail.md` |
