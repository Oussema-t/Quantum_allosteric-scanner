...
| TASK-0096 | Delete or implement the phantom `H11_anisotropic_mechanical`/`H12_anm_scalarised` operators — both verified (`np.allclose`) identical to `H6`/unweighted-contact Laplacian despite docstrings claiming anisotropic weighting; closes TASK-0037 for real (fix or removal, not just "known gap") — REVIEW-2026-07-13 P2-A | Implementer | TODO | P2 | 2026-07-13 | — | — | `.ai/tasks/TODO/TASK-0096-delete-or-implement-phantom-operators.md` |
