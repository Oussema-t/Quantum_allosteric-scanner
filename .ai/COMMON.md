...
| TASK-0099 | Wire a genuine coherence-sensitivity metric into the scored verdict path — `analysis.coherence_sensitivity` wires `dephasing_sweep` into `assemble_verdict_results`/`verdict_template` (calibrated γ, floor-gated via `classify_failure`). KRAS_G12C real result: flat, `COHERENCE_NOT_SIGNIFICANT`, robust across t_max∈{8,25,100} and 2 seed conventions (post-completion audit vs `REVIEW-panel-2026-07-16-v2`). BCR_ABL1/CARDIAC_MYOSIN blocked on `calibrate_kappa`'s exactly-6-mode assertion — filed as TASK-0128. New: INV-0005, SEAM-0008 extended, pitfalls P-0003 | Implementer | Done | P1 | 2026-07-16 | — | — | `.ai/tasks/DONE/TASK-0099-wire-coherence-metric-into-scored-verdict.md` |
