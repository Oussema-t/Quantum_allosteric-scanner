...
| TASK-0097 | Name the "quantum metric" honestly — state in `RESULTS.md`/methodological report that `time_averaged_ctqw` is the decoherent/infinite-time-average limit (a spectral overlap quantity), not a coherent quantum walk — REVIEW-2026-07-13 P2-B | Implementer | TODO | P2 | 2026-07-13 | — | — | `.ai/tasks/TODO/TASK-0097-name-quantum-metric-honestly.md` |
