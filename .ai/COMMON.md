...
| TASK-0101 | Operator sweep Tier-1 harness — `analysis.operator_sweep` + `scripts/sweep_operators.py`, scores all 14+2 operators against TASK-0094's proximity floor on all 3 mandatory targets, reports a table (floor-cleared/AUC/tier per operator). Tier-2 selection explicitly out of scope — follow-up from TASK-0100's decision | Implementer | TODO | P1 | 2026-07-13 | — | — | `.ai/tasks/TODO/TASK-0101-operator-sweep-tier1-harness.md` |
