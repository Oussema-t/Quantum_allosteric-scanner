...
| TASK-0025 | Single-command preference + reusable-script convention for all threads (widened from `.ai/`-only), delivered as a `.github/instructions/` policy doc + Claude Skill | Skills Crafter | Done | P2 | 2026-07-04 | Skills Crafter (this thread) | 2026-07-04 16:30 | `.ai/tasks/DONE/TASK-0025-command-hygiene-skill.md` |
