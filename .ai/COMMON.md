...
| TASK-0026.001 | Dispatcher entry point + `repo.vcs.*` primitives + `repo.packaging.snapshot` | Toolsmith | In Progress | P1 | 2026-07-04 | — | — | `.ai/tasks/IN_PROGRESS/TASK-0026.001-vcs-core.md` |
...
| TASK-0026.005 | `pytest_local.py` uses `sys.executable` unconditionally — fails in any environment where the wrapper's own interpreter lacks the test deps (hit directly: fresh checkout, no ambient `.venv`); resolve `.venv/bin/python3` first, fall back unchanged | Toolsmith | TODO | P2 | 2026-07-09 | — | — | `.ai/tasks/TODO/TASK-0026.005-pytest-local-venv-resolution.md` |
