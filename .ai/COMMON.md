...
| TASK-0052 | Reconcile `test_leakage_gate.py`'s assumed `build_labels`/`FrozenConfig`/`lopo` contract against the real `labels.py`/`protocol.py` API — owns SEAM-0003 | Implementer | TODO | P1 | 2026-07-11 | Implementer A (this thread) | 2026-07-12 09:07 | `.ai/tasks/TODO/TASK-0052-reconcile-leakage-gate-contract.md` |
