...
| TASK-0089 | Classify `select.py`'s reported quantities (GAUGE/KNOB/SIGNAL) — closes `INV-0004`, flagged by TASK-0064 | Implementer | TODO | P2 | 2026-07-12 | Implementer A (this thread) | 2026-07-12 12:27 | `.ai/tasks/TODO/TASK-0089-select-invariance-classification.md` |
...
| TASK-0098 | Amend `.ai/reference/INVARIANCE_PROTOCOL.md`'s SIGNAL class — null control must ask "does it beat the strongest domain heuristic (distance-from-seed)?", not just "does it beat random?" — third instance of an unexecuted assumed-gauge symmetry per REVIEW-2026-07-13's Meta section (after SE(3) rotation, SU(2)/Clifford-frame) | Architect/Planner | TODO | P2 | 2026-07-13 | — | — | `.ai/tasks/TODO/TASK-0098-amend-invariance-protocol-signal-class.md` |
...
| TASK-0113 | Re-run TASK-0067's cutoff/weight-scheme sweep against the actual headline operator (`H_new` + both propagators) — TASK-0067 validated a bare-Laplacian proxy, not the operator that produces reported AUCs — `REVIEW-2026-07-15-execution-plan-gap-audit.md` finding #2 | Implementer | TODO | P2 | 2026-07-15 | — | — | `.ai/tasks/TODO/TASK-0113-cutoff-sweep-headline-operator.md` |
| TASK-0114 | Pocket-label ligand-contact cutoff (4.5 Å) sensitivity sweep — distinct from the GNM graph cutoff, this threshold defines ground truth itself and has no reported spread, same failure mode TASK-0075 found in the overlap gate — `REVIEW-2026-07-15-execution-plan-gap-audit.md` finding #3 | Implementer | TODO | P2 | 2026-07-15 | — | — | `.ai/tasks/TODO/TASK-0114-pocket-label-cutoff-sensitivity.md` |
| TASK-0115 | Name and gate the repeated-exposure risk across ~15 human review cycles on the same 3-target answer key — code-level gates (`frozen_context`/TASK-0100) can't catch it; document + require TASK-0081's generalization set before any `RESULTS.md` claim is final — `REVIEW-2026-07-15-execution-plan-gap-audit.md` finding #4 | Architect/Planner | TODO | P2 | 2026-07-15 | — | — | `.ai/tasks/TODO/TASK-0115-repeated-exposure-generalization-gate.md` |
| TASK-0116 | Ceiling search (TASK-0046) blind 60-trial random search over ~8D is weak evidence for its own "no headroom" negative claim — re-run with a space-filling design or real optimizer on KRAS_G12C — `REVIEW-2026-07-15b-ceiling-search-methodology.md` finding #1 | Implementer | TODO | P1 | 2026-07-15 | — | — | `.ai/tasks/TODO/TASK-0116-ceiling-search-coverage-upgrade.md` |
| TASK-0117 | Ceiling search's `t_max=15`/`n_steps=500` share the same unvalidated CTQW parameters TASK-0108/0109/0110 exist to check — apply TASK-0109's convergence check to `ceiling.py` once it lands, hard-blocked — `REVIEW-2026-07-15b-ceiling-search-methodology.md` finding #2 | Implementer | TODO | P1 | 2026-07-15 | — | — | `.ai/tasks/TODO/TASK-0117-ceiling-search-convergence-dependency.md` |
