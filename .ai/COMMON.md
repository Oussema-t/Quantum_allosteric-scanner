...
| TASK-0030 | Extract a shared, unit-tested Kabsch helper in `backend/` — dedupes `discovery.py::_kabsch` / `analysis.py::_kabsch_rotate`; reuse target for TASK-0005; concrete instance of TASK-0018 evidence #6 | Implementer | Done | P2 | 2026-07-05 | Implementer (this thread) | 2026-07-05 19:01 | `.ai/tasks/DONE/TASK-0030-backend-kabsch-dedup.md` |
