...
| TASK-0080 | c-Myc/1NKP application — no holo ground truth, route to consensus + theoretical docking viability reporting instead of AUC/ceiling — `EXECUTION_PLAN.md` Phase 5.7 | Implementer | TODO | P2 | 2026-07-12 | Implementer C (this thread) | 2026-07-15 07:12 | `.ai/tasks/TODO/TASK-0080-cmyc-1nkp-application.md` |
