...
| TASK-0079.001 | Schema assembly: `analysis.py` real nested output -> `report.py`'s flat results dict — closes SEAM-0008 | Implementer | TODO | P0 | 2026-07-12 | Implementer A (this thread) | 2026-07-12 17:21 | `.ai/tasks/TODO/TASK-0079.001-analysis-report-schema-assembly.md` |
| TASK-0079.002 | Connectivity matrix (`pathways.edge_propensity` half-matrix -> dense N×N array) + hit-list assembly (`report.hit_list`) | Implementer | TODO | P0 | 2026-07-12 | — | — | `.ai/tasks/TODO/TASK-0079.002-connectivity-matrix-hit-list-assembly.md` |
| TASK-0079.003 | FROZEN-gated per-target verdict pipeline — `select_frozen_config` -> `analysis.py` scoring -> `stamp_provenance` -> .001's assembly, all inside one `frozen_context` | Implementer | TODO | P0 | 2026-07-12 | — | — | `.ai/tasks/TODO/TASK-0079.003-frozen-gated-verdict-pipeline.md` |
| TASK-0079.004 | One-command orchestrator (`run_challenge.py --target ...`) + output files — depends on .002, .003 | Implementer | TODO | P0 | 2026-07-12 | — | — | `.ai/tasks/TODO/TASK-0079.004-one-command-orchestrator.md` |
