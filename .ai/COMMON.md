...
| TASK-0108 | CTQW/propagator parameter validity + Optuna floor/ceiling scan (parent/coordinator for TASK-0109/0110) — filed per explicit user request after confirming zero validity checks exist for t_max/n_steps/gamma | Architect/Planner | TODO | P1 | 2026-07-15 | Architect/Planner (this thread) | 2026-07-15 07:23 | `.ai/tasks/TODO/TASK-0108-ctqw-parameter-validity-and-optuna-scan.md` |
