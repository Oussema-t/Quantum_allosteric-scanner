...
| TASK-0095 | Correct propagator semantics — rename `heat`→`ground_state_relaxation` (or equivalent), guard against feeding an indefinite operator into any diffusion-semantics path, correct `RESULTS.md`/report framing. REVIEW-2026-07-13 P1-B: `heat(H_new)` is the ground-state density (Spearman 0.998 vs `\|ground state\|²`), not classical diffusion — BCR_ABL1's "0.731 classical heat" framing is currently a false physical claim | Implementer | TODO | P1 | 2026-07-13 | — | — | `.ai/tasks/TODO/TASK-0095-correct-propagator-semantics.md` |
